...
// int WriteDangvan(vtkSmartPointer<vtkUnstructuredGrid> unstructuredGrid, int nesets,  std::string newname, int slip);
...
//_____________________________________________________________________     
 ...
 /*  
   ...
   //my part_______________________________________________________________________________________________________
   //
...
//     if(flagggg)
//     {
//     WriteDangvan(unstructuredGrid,nesets, "dang van 1", 1);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 2", 2);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 3", 3);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 4", 4);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 5", 5);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 6", 6);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 7", 7);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 8", 8);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 9", 9);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 10", 10);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 11", 11);
//     WriteDangvan(unstructuredGrid,nesets, "dang van 12", 12);
//     flagggg=false;
//     }
//     
